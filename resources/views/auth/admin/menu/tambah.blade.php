...
@section('isi')
    <div class="col-12 shadow-sm p-3 mb-5 rounded border border-1" style="background-color: #e7eaed">
        <form class="m-5" method="POST" action="/menu" enctype="multipart/form-data">
            @csrf

            <img id="imagePreview" class="mb-3 rounded-3" src="#" alt="Preview Image"
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="/users" class="ms-2 text-decoration-none btn btn-danger py-1 ps-2 pe-3">
